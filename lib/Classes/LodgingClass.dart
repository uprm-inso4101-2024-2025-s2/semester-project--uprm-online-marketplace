...
class Lodging extends Product{
  ...
  @override
  String toString() {
    return 'Lodging(id: $id, title: $title, description: $description, location: $location, price: $price, bedrooms: $bedrooms, restrooms: $restrooms, parking: $parking, availability: $availability, condition: $condition, owner: $owner, uid: $uid, isFavorite: $isFavorite, imageUrls: $imageUrls)';
  }
