...
class SignUpPageState extends State<SignUpPage> {
  ...
  void signUp() async {
    ...
    String role =
        "Student"; //auth_service added a role parameter. Signup process has yet to incorporate this adition into the code
    ...
    try {
      String? user = (await authService.signUpWithEmailPassword(
        email,
        password,
      ));
